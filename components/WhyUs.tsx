...
import {
  GraduationCap, PackageCheck, ShieldCheck, Headphones, CalendarCheck, ArrowRight,
} from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5">
          ...
          <h2 className="headline font-display text-4xl sm:text-5xl lg:text-6xl text-[#14141A] mb-5">
            NEDEN
            <br />
            <span className="text-[#E63946]">CANBEY OTO?</span>
          </h2>
            ...
            {reasons.map((r) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#5A5A66]">{r.desc}</p>
                </div>
              </li>
            ))}
          </ul>
